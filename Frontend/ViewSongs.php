...
<!--Start Container for the web content-->
	<div class="playlist_wrapper">
        	...
        	<div class="playlist_info">
				...
				?>
                	<tr>
                    	<td><?php echo "<img src=../Administrator/PHP/upload_images/genre/$row[albumimage] height=140 width=130/>";?></td>
                        <td>
                        	<table>
                            	<tr>
...
<div class="footer_wrapper">
    <div class="footer_menu">
        ...
        <br /> <br /> <br />
        <span style="color:#999; font-size:14px; margin-top:10px;">&copy;2023 BMEG Music, Inc.</span>
    </div>
</div>
</body>
</html>
